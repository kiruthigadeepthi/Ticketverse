...
class Activitybooking:
    ...
    def bookactivity(self):
        ...
        time.sleep(2)
        type.click()
        select_type=self.driver.find_element(By.XPATH,"/html/body/div[2]/div[1]/ul/li[2]/div[2]/label[2]/span")
        time.sleep(2)
        select_type.click()
        time.sleep(2)
